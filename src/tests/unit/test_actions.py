...
class TestActions():
    def test_get_pass_action(self, smb, mock_action_get, mock_action_set,
                             mock_action_fail, mock_juju_unit, monkeypatch):
    ...
    def test_set_pass_action(self, smb, mock_action_get, mock_action_set,
                             mock_action_fail, mock_juju_unit, monkeypatch):
        mock_function = mock.Mock()
